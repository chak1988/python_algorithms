...
NEW_DEQUE1 = deque(string.ascii_uppercase)
NEW_DEQUE2 = list(string.ascii_uppercase)
print(NEW_DEQUE2)
print(timeit('NEW_DEQUE1.appendleft(1)', globals = globals(), number = 10000))
print(timeit('NEW_DEQUE2.insert(0, 1)', globals = globals(), number = 10000))
