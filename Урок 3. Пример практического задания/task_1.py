...
# Добавление элементов в словарь происходит дольше, т.к. при создании словаря
# необходимо вычислять хеши ключей
...
# Зато поиск элемента из словаря по ключу происчодит гораздо быстрее,
