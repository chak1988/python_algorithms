...
print(timeit("concat_test()", setup="from __main__ import concat_test", number=1000))
print(timeit("append_test()", setup="from __main__ import append_test", number=1000))
